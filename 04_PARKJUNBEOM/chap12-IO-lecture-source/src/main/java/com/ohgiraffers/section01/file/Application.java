    ...
    public static void main(String[] args) {
        ...
        * */
        ...
        try {
            ...
            //파일이 한 번 생성되고 난 이후 새롭게 파일을 만들지 않기 때문에
        ...
        boolean deleteSuccess2 = new File("C:\\devTest\\test").delete();
        System.out.println("deleteSuccess2 = " + deleteSuccess2);

        boolean deleteSuccess3 = new File("C:\\devTest").delete();
        System.out.println("deleteSuccess3 = " + deleteSuccess3);

        // 폴더의 생성여부를 exists() 메소드를 이욯해서 판별
