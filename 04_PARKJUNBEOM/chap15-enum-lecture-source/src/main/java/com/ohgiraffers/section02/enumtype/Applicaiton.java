...
public class Applicaiton {
    ...
    public static void main(String[] args) {
        ...
        Subjects subject3 = Subjects.CSS;
        ...
        * */
        ...
        // 이름 충돌 방지를 위해 접두사르 쓰지않아도 Enum타입별로 네임스페이스를 가진다.
        Subjects.BackEnd javascript = Subjects.BackEnd.JAVASCIRPT;
        System.out.println("javascript = " + javascript);
        Subjects.BackEnd javascript2 = Subjects.BackEnd.JAVASCIRPT;
