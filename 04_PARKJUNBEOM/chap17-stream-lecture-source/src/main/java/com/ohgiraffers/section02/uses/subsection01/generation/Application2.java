...
public class Application2 {
    ...
    public static void main(String[] args) {
        ...
        * boxed() : 기본 차입 스트림인 XXXStream을 박싱하여 Wrapper타입의 Stream<XXX>으로 반환한다.
        * */
        System.out.println();
        ...
        Stream<String> stringStream2 = Stream.of("ByeBye", "world", "java");
//        stringStream.forEach(System.out::println);
//        stringStream2.forEach(System.out::println);

        // concat()을 이용하여 두 개의 스트림을 동일 타입스트림으로 합칠 수 있다.
        // 스트림은 1회성으로 사용 가능하며 이미 열린 스트림은 재사용이 불가능하다.
        // 위에꺼 주석을 안하면 IllegalStateException 발생
