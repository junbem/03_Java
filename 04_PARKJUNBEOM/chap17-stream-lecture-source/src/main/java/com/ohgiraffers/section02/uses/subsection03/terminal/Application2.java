...
public class Application2 {
    public static void main(String[] args) {
        ...
        // 인자가 2개일 경우
        int reduceTowParam = IntStream.range(1, 4).reduce(100, Integer::sum);
        System.out.println("reduceTowParam = " + reduceTowParam);

        // 인자가 3개일 경우
        Integer reduceThreeParam = Stream.of(1, 2, 3, 4)
