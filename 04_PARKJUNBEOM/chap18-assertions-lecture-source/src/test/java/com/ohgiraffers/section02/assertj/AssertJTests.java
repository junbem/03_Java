...
class AssertJTests {
    ...
    void testLocalDateTimeValidation() {
        String birthday = "2000-06-25T116:49:00.000";
        ...
        Assertions.assertThat(birth)
                ...
                .hasMonthValue(6)
                .hasDayOfMonth(25)
                .isBetween("2000-0-1-01T16:49:00.0000", "2000-12-25T16:49:00.0000")
    ...
    void testExceptionValidation() {
        Throwable thrown = AssertionsForClassTypes.catchThrowable(() -> {
                    throw new IllegalArgumentException("잘못된 파라밑를 입력하였습니다.");
        });
