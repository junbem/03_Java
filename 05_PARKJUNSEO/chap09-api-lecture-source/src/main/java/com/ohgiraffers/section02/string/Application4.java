...
public class Application4 {
    ...
    public static void main(String[] args) {
        ...
        System.out.printf("%s%s", "안녕하세요", "저는 홍길동입닏.");
        System.out.printf("%s\n%s\n", "안녕하세요", "저는 홍길동입닏.");
        System.out.println("test");    // println은 뒤에 줄바꿈함
        String str = """
                   """.formatted("test", "test");
        System.out.println("안녕하세요.\t저는 홍길동입니다.");

        System.out.println("안녕하세요. 저는 '홍길동' 입니다.");
        // System.out.println('''); // 홀따옴표 문자와 문자 리터럴 기호가 중복
        System.out.println('\'');   // 이거 가능함
        System.out.println("안녕하세요. 저는 \"홍길동\" 입니다.");
        System.out.println("안녕하세요. 저는 \\홍길동\\입니다.");
